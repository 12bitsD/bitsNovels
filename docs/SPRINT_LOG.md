...
- [ ] US-1.4 FE：项目设置页面
- [ ] US-1.5 BE+FE：卷章目录管理（卷CRUD/排序/软删除、章CRUD/跨卷移动/批量操作）
- [ ] US-1.6 BE+FE：写作目标设定（每日/总字数目标、截止日期、进度统计）
- [ ] US-1.8 BE+FE：项目归档（归档/取消归档、归档后只读）
- [ ] E2E 测试：US-1.4/1.5/1.8 覆盖
