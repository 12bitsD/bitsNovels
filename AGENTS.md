...
| US-1.5 | 卷章目录管理（卷CRUD/排序/软删除、章CRUD/跨卷移动/批量操作） | ✅ | 🔲 | Task 4 完成，commit 667e43e |
| US-1.6 | 写作目标设定（每日/总字数目标、截止日期、进度统计） | ✅ | 🔲 | Task 5 完成，commit f2e412b |
| US-1.8 | 项目归档（归档/取消归档、归档后只读） | ✅ | 🔲 | Task 3 完成，commit 9d67cae |
